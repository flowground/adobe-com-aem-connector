 ...
 *
 * Generated at: 2019-05-07T14:34:46.021Z
 ...
 * Endpoint Path: '/etc/packages/{group}/{name}-{version}.zip/jcr:content/vlt:definition/filter.tidy.2.json'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/etc/packages/{group}/{name}-{version}.zip/jcr:content/vlt:definition/filter.tidy.2.json',
        method: 'get',
