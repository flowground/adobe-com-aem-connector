 ...
 * Endpoint Path: '/apps/system/config/com.shinesolutions.aem.passwordreset.Activator'
 * Method: 'post'
 *
 */
...
const FIELD_MAP = {
    ...
    "pwdreset_authorizables_TypeHint": "pwdreset.authorizables@TypeHint"
};
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/apps/system/config/com.shinesolutions.aem.passwordreset.Activator',
        method: 'post',
